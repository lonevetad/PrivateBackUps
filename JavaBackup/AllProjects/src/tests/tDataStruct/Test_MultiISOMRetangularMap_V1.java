...
public class Test_MultiISOMRetangularMap_V1 {
	 ...
	 * Construct
	 */
	public Test_MultiISOMRetangularMap_V1() {
...
//				sb.append(t);
	...
	public static final void main(String[] args) {
		...
		rects = Arrays.asList(new MyRectangle[] { //
				new MyRectangle(0, 0, 5, 20).setName("a"), //
				new MyRectangle(5, 3, 10, 2).setName("b"), //
				new MyRectangle(13, 1, 7, 6).setName("c"), //
				new MyRectangle(14, 7, 3, 5).setName("d"), // d
				new MyRectangle(12, 9, 2, 2).setName("e"), //
				new MyRectangle(8, 8, 4, 6).setName("f"), // f
				new MyRectangle(7, 9, 5, 20).setName("g"), //
				new MyRectangle(6, 14, 3, 3).setName("h"), //
				new MyRectangle(12, 12, 10, 3).setName("i"), // i
				new MyRectangle(11, 16, 1, 4).setName("l"), //
				new MyRectangle(13, 15, 2, 5).setName("m"), //
				new MyRectangle(16, 15, 2, 3).setName("n"), //
				new MyRectangle(6, 0, 5, 20).setName("o"), // o
				new MyRectangle(7, 1, 2, 2).setName("p"), //
				new MyRectangle(5, 19, 3, 2).setName("q"), //
				new MyRectangle(18, 5, 3, 4).setName("r"), //
				new MyRectangle(15, 18, 4, 2).setName("s"), //
		});
		factor = 4;
