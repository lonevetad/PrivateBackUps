...
public class SynonymSet implements SortedSetEnhancedDelegating<String>, Cloneable {
	...
	protected static final Comparator<SortedSetEnhanced<String>> COMP_SET_STRING = SortedSetEnhanced
			.newComparatorIntersectThenMissThenExceed(Comparators.STRING_COMPARATOR);
	...
	protected SynonymSet() {
		backMap = MapTreeAVL.newMap(MapTreeAVL.Optimizations.MinMaxIndexIteration, Comparators.STRING_COMPARATOR);
