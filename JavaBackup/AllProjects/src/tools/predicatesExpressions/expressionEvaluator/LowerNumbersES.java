...
public class LowerNumbersES<E extends Number> extends TwoNumbersEvaluator<E> {
	private static final long serialVersionUID = 641087319164364L;

	public LowerNumbersES(E v1, E v2) {
		super(v1, v2);
	}

	protected LowerNumbersES(TwoNumberHolder<E> del) {
		super(del);
	}
