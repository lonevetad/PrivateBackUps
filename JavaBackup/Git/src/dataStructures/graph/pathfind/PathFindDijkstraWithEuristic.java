...
public class PathFindDijkstraWithEuristic<E> implements PathFindStrategy<E> {
	private static final long serialVersionUID = 56409561023300330L;

	public PathFindDijkstraWithEuristic(BiFunction<E, E, Double> heuristic) {
		super();
	...
	public PathFindDijkstraWithEuristic<E> setHeuristic(BiFunction<E, E, Double> heuristic) {
		this.heuristic = heuristic;
		return this;
	}
